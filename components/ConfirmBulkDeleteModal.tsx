...
const ConfirmBulkDeleteModal: React.FC<ConfirmBulkDeleteModalProps> = ({ isOpen, onClose, onConfirm, itemCount }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
        ...
        if (document.getElementById('bulk-delete-modal-title')) {
           setIsDeleting(false);
        }
    }
  };
  ...
  return (
    <div onClick={onClose} className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4" role="dialog" aria-modal="true" aria-labelledby="bulk-delete-modal-title">
      <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-xl shadow-2xl w-full max-w-md">
        <div className="p-6 text-center">
            ...
            <h2 id="bulk-delete-modal-title" className="text-lg font-semibold text-gray-800 mt-4">Delete Multiple Products</h2>
